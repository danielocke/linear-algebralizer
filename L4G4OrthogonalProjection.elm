...
myShapes model inputPoint inputLine =
  [
    grid
 -- --------------------------------------------------------------
 -- Orthoganal proj of projPoint onto the line spanned by projLine
 -- --------------------------------------------------------------
  , plotLine vPink inputLine
  , plotTransf model vOrange 5 inputPoint (orthProj inputPoint inputLine)
  , plot 5 vNavy inputPoint
  ]
...
view model = collage 192 128 (myShapes model projPoint projLine)
